<div class="row">
                ...
                <div class="carousel-inner p-0 col-12 col-lg-12">
                        ...
                        <div class="row m-0">
                            <div class="right-col col-5 d-flex imgboxofer">
                                <a class="w-100 text-center" href="single-product.html">
                                    <img src="{{ asset('user/img/product_img/p_1.jpg') }}" class="img-fluid"
                                         alt="">
                            ...
                            <div class="left-col col-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <ul class="list-group space-15">
                                            <li class="list-group-item">قابلیت‌های مقاومتی : مقاوم در برابر
                                                آب
                                            </li>
                    ...
                    <div class="carousel-item">
                        <div class="row m-0">
                            <div class="right-col col-5 d-flex imgboxofer">
                                <a class="w-100 text-center" href="single-product.html">
                                    <img src="{{ asset('user/img/product_img/p_3.jpg') }}" class="img-fluid"
                                         alt="">
                    ...
                    <div class="carousel-item">
                        <div class="row m-0">
                            <div class="right-col col-5 d-flex imgboxofer">
                                <a class="w-100 text-center" href="single-product.html">
                                    <img src="{{ asset('user/img/product_img/p_5.jpg') }}" class="img-fluid"
                                         alt="">
                    ...
                    <div class="carousel-item  finished">
                        <div class="row m-0">
                            <div class="right-col col-5 d-flex imgboxofer">
                                <a class="w-100 text-center" href="single-product.html">
                                    <img src="{{ asset('user/img/product_img/p_7.jpg') }}" class="img-fluid"
                                         alt="">
                            ...
                            <div class="left-col col-7">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <ul class="list-group space-15">
                                            <li class="list-group-item"> صفحه‌نمایش : Super Retina XDR
                                                OLED
                                            </li>
                    ...
                    <div class="carousel-item  finished">
                        <div class="row m-0">
                            <div class="right-col col-5 d-flex imgboxofer">
                                <a class="w-100 text-center" href="single-product.html">
                                    <img src="{{ asset('user/img/product_img/p_9.jpg') }}" class="img-fluid"
                                         alt="">
                                    <span class="discount-percent">7 % تخفیف</span>
                    ...
                    <div class="carousel-item">
                        <div class="row m-0">
                            <div class="right-col col-5 d-flex imgboxofer">
                                <a class="w-100 text-center" href="single-product.html">
                                    <img src="{{ asset('user/img/product_img/p_11.jpg') }}"
                                         class="img-fluid" alt="">
                        ...
                        <div class="row m-0">
                            <div class="right-col col-5 d-flex imgboxofer">
                                <a class="w-100 text-center finished" href="single-product.html">
                                    <img src="{{ asset('user/img/product_img/p_15.jpg') }}"
                                         class="img-fluid " alt="">
                                    <img src="{{ asset('user/img/sell.png') }}" class="imgfinish">
                            ...
                            <div class="left-col col-7">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <ul class="list-group space-15">
                                            <li class="list-group-item">فناوری صفحه‌نمایش : Super AMOLED
                                            </li>
                    ...
                    <div class="carousel-item">
                        <div class="row m-0">
                            <div class="right-col col-5 d-flex imgboxofer">
                                <a class="w-100 text-center" href="single-product.html">
                                    <img src="{{ asset('user/img/product_img/p_17.jpg') }}"
                                         class="img-fluid" alt="">
                                    <span class="discount-percent">3 % تخفیف</span>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <ul class="list-group space-15">
                                            ...
                                            <li class="list-group-item">اقلام همراه : دفترچه‌ راهنما،
                                                شارژر
                                            </li>
                                        </ul>
                                    </div>
    ...
    {{--LEFT SMALL PRODUCTS SLIDER START--}}
            ...
            <div id="bid-s" class="owl-carousel owl-theme">
                ...
                <div class="item">
                    ...
                    <div class="price">
                        ...
                        <span class="amount">12,180,000<span>تومان</span> <span
                                class="discount_badge">3%</span></span>
                    </div>
                </div>
                <div class="item">
                    <a href="single-product.html">
    ...
    {{--LEFT SMALL PRODUCTS SLIDER END--}}
    {{--CATEGOY BANNERS START--}}
    <div class="col-12">
            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-6 col-lg-3">
                        <div class="widget-banner card border_all">
                            <a href="category-search.html" target="_blank">
                                <img class="img-fluid" src="{{ asset('user/img/banner_img/img-3.jpg') }}"
                                     alt="">
                            </a>
                        </div>
                    </div>
                    <div class="col-6 col-lg-3">
                        <div class="widget-banner card">
                            <a href="category-search.html" target="_top">
                                <img class="img-fluid" src="{{ asset('user/img/banner_img/img-4.jpg') }}"
                                     alt="">
                            </a>
                        </div>
                    </div>
                    <div class="col-6 col-lg-3">
                        <div class="widget-banner card border_all">
                            <a href="category-search.html" target="_blank">
                                <img class="img-fluid" src="{{ asset('user/img/banner_img/img-5.jpg') }}"
                                     alt="">
                            </a>
                        </div>
                    </div>
                    <div class="col-6 col-lg-3">
                        <div class="widget-banner card">
                            <a href="category-search.html" target="_top">
                                <img class="img-fluid" src="{{ asset('user/img/banner_img/img-6.jpg') }}"
                                     alt="">
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-12">
                <div class="widget widget-product card border_all bglight pad_time_prod" id="shegeft_1">
                    ...
                    <div class="product-carousel owl-carousel owl-theme">
                        <div class="item">
                            <a href="single-product.html">
                                <img src="{{ asset('user/img/product_img/p_14.jpg') }}" class="img-fluid"
                                     alt="">
                            </a>
                        ...
                        <div class="item">
                            <a href="single-product.html">
                                <img src="{{ asset('user/img/product_img/p_2.jpg') }}" class="img-fluid"
                                     alt="">
                            </a>
                            <h2 class="product_title">
                        ...
                        <div class="item">
                            <a href="single-product.html">
                                <img src="{{ asset('user/img/product_img/p_12.jpg') }}" class="img-fluid"
                                     alt="">
                            </a>
                            <h2 class="product_title">
                                <a href="single-product.html"> کنسول بازی Playstation 5 با هارد 870
                                    مگابایت </a>
                            </h2>
                            <div class="price">
                        ...
                        <div class="item">
                            <a href="single-product.html">
                                <img src="{{ asset('user/img/product_img/p_6.jpg') }}" class="img-fluid"
                                     alt="">
                            </a>
                            <h2 class="product_title">
                        ...
                        <div class="item">
                            <a href="single-product.html">
                                <img src="{{ asset('user/img/product_img/p_10.jpg') }}" class="img-fluid"
                                     alt="">
                            </a>
                            <h2 class="product_title">
                        ...
                        <div class="item">
                            <a href="single-product.html">
                                <img src="{{ asset('user/img/product_img/p_17.jpg') }}" class="img-fluid"
                                     alt="">
                            </a>
                            <h2 class="product_title">
            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-12 col-lg-6">
                        <div class="widget-banner card border_all">
                            <a href="category-search.html" target="_blank">
                                <img class="img-fluid" src="{{ asset('user/img/banner_img/img-7.jpg') }}"
                                     alt="">
                            </a>
                        </div>
                    </div>
                    <div class="col-12 col-lg-6">
                        <div class="widget-banner card">
                            <a href="category-search.html" target="_top">
                                <img class="img-fluid" src="{{ asset('user/img/banner_img/img-8.jpg') }}"
                                     alt="">
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-12">
                <div class="widget widget-product card border_all bglight">
                    ...
                    <div class="product-carousel owl-carousel owl-theme">
                        ...
                        <div class="item">
                            <a href="#">
                                <img src="{{ asset('user/img/product_img/p_15.jpg') }}" class="img-fluid"
                                     alt="">
                            </a>
                            <h2 class="product_title">
                                <a href="#"> گوشی موبایل سامسونگ گلکسی A32 </a>
                        ...
                        <div class="item">
                            <a href="#">
                                <img src="{{ asset('user/img/product_img/p_19.jpg') }}" class="img-fluid"
                                     alt="">
                            </a>
                            <h2 class="product_title">
                        ...
                        <div class="item">
                            <a href="#">
                                <img src="{{ asset('user/img/product_img/p_21.jpg') }}" class="img-fluid"
                                     alt="">
                            </a>
                            <h2 class="product_title">
                        ...
                        <div class="item">
                            <a href="#">
                                <img src="{{ asset('user/img/product_img/p_20.jpg') }}" class="img-fluid"
                                     alt="">
                            </a>
                            <h2 class="product_title">
